...
// To not have every link be a complete refresh, you gotta setup some Inertia stuff
// Using Link, an AJAX request is sent instead. You'll be returned a JSON object with the data you need for the views.

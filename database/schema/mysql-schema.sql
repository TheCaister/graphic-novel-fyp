...
CREATE TABLE `chapters` (
  ...
  `chapter_thumbnail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chapter_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `elementables` (
  ...
  `elementable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `elements` (
  ...
  `element_thumbnail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `derived_element_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `derived_element_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `series` (
  ...
  `series_summary` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
